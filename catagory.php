...
<?php 
   ...
   // echo $querystring;
    ...
    $result = mysqli_query($con,"SELECT * FROM details where catagory LIKE '$querystring' OR company LIKE '$cat'");
...
<body style="background-color: #000">
    ...
    <section id="result">
        <div class="container">
            ...
            ?>
            <div class="row">
                <img id="cover-pic" src="<?php echo $row['photo'] ?>" alt="image">
            </div>
            <div class="row">
                <h6 id="company-name"><?php echo $row['company'] ?></h6>
            </div>
            <div class="row">
                <p id="description"><?php echo substr($row['description'], 0, 200)?> ...</p>
            </div>
            <div class="row">
