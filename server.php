...
if (isset($_POST['add_profile'])) {
  ...
  if($catagory === "select")
  {
    echo "<script>alert('You have to select catagory');</script";
  }
  else
  {
    if (empty($company)) {
    ...
    if (count($errors) == 0) {
      $query = "INSERT INTO details (username,company,description,contact,address,catagory) VALUES('$username','$company', '$description','$contact','$address' , '$catagory')";
